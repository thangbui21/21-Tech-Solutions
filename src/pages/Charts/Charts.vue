...
<div class="charts-overview">
    ...
    <div>
        <b-row>
            ...
            <b-col xs="12" lg="5">
                <Widget title="<h5>Echarts <span class='fw-semi-bold'>Line Chart</span></h5>" close collapse customHeader>
            ...
            <b-col xs='12' lg='7'>
                <b-row>
                    <b-col xs="12" lg="6">
                        <Widget title="<h5>Apex <span class='fw-semi-bold'>Monochrome Pie</span></h5>" close collapse customHeader>
                    ...
                    <b-col xs="12" lg="12">
                        <Widget title="<h5>Highcharts <span class='fw-semi-bold'>Live Chart</span></h5>" close collapse customHeader>
